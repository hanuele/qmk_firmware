 ...
 *                        `----------------------------------'  `----------------------------------'
  ...
  */
     [_NAV] = LAYOUT(
       ...
       _______, LSA(KC_DOWN), KC_HOME, KC_DOWN, KC_END, LSA(KC_UP), _______, _______, XXXXXXX, _______, _______, C(KC_LGUI),_______,  _______, _______, _______,
                                  _______, _______, _______, _______, _______, _______, A(KC_TAB), LGUI(KC_TAB), _______, _______
     ),
 /*
